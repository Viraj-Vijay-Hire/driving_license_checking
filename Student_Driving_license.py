...
label_Date of Birth= Label(root)
label_Pin = Label(root)
label_Address = Label(root)
label_Authorisation to drive the following vehicle = Label(root)
...
def myLicenseDetails():
    ID = "9987151126785"
    print(type(ID))
    Name = "Viraj Vijay Hire"
    print(type(Name))
    Date of Birth = "22 October 2009"
    print(type(Date of Birth))
    Pin = "400705"
    print(type(Pin))
    Address = "Sanpada, Navi Mumbai"
    print(type(Address))
    Authorisation to drive the following vehicle = "Two four"
    print(type(Authorisation to drive the following vehicle))
